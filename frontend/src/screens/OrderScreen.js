...
export default function OrderScreen() {
    ...
    return loading ? (
        ...
        <div>
            <h1 className="my-3">Your Order details</h1>
            <h4 className="my-3">ID : {orderId}</h4>
            <Row>
                <Col md={8}>
                    <Card className="mb-3">
                        <Card.Body>
                            ...
                            <Alert variant='light'>
                            <label><i class="fa-solid fa-truck"></i> About our logistic policies</label>
                            <hr />
                            Normally 2 to 5 working days are required for delivery; from 12 to 15 if the products are in localized warehouses
                            </Alert>
